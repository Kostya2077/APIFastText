...
from api.fastText.compress.quantization import quantize
from api.fastText.compress.decomposition import DecomposedMatrix
from api.fastText.compress.prune import prune_ngrams, prune_vocab, count_buckets, RowSparseMatrix
